...
#        Regression test for Image Factory #bug782950
#        Created by koca (mkoci@redhat.com)
#        Date: 30/01/2012
#        Issue: Bug 782950 - change "max_concurrent_local_sessions": 1 to "2"
# return values:
# 0 - OK: everything OK
...
CrazyCommand=["aeolus-image build --target rhevm,vsphere --template templates/bug782950.tdl --environment default"]
...
def setupTest():
    print "=============================================="
    print "Setup of the regression test based on Bug 782950 - change \"max_concurrent_local_sessions\": 1 to \"2\""
    print "See the bug for further information - https://bugzilla.redhat.com/show_bug.cgi?id=782950"
