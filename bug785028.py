...
#        Regression test for Image Factory #bug785028
#        Created by koca (mkoci@redhat.com)
#        Date: 30/01/2012
#        Issue: https://bugzilla.redhat.com/show_bug.cgi?id=785028 - package group installs need to handle whitespaces
# return values:
# 0 - OK: everything OK
...
TmpFile="deleteme_bug785028"
CrazyCommand="imagefactory --debug --target vsphere --template templates/bug785028.tdl |& tee " + TmpFile 
...
def setupTest():
    print "=============================================="
    print "Setup of the regression test based on Bug 785028 - package group installs need to handle whitespaces"
    print "See the bug for further information - https://bugzilla.redhat.com/show_bug.cgi?id=785028"
