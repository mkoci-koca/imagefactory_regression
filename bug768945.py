...
#        Regression test for Image Factory #bug768945
#        Created by koca (mkoci@redhat.com)
#        Date: 09/01/2012
#        Issue: https://bugzilla.redhat.com/show_bug.cgi?id=768945 -Build failures using system engine template that installs additional packages
# return values:
# 0 - OK: everything OK
...
CrazyCommand=["aeolus-image build --target rhevm --template templates/bug768945.tdl;"]
...
def setupTest():
    print "=============================================="
    print "Setup of the regression test based on bug768945 -Build failures using system engine template that installs additional packages"
    print "See the bug for further information - https://bugzilla.redhat.com/show_bug.cgi?id=768945"
